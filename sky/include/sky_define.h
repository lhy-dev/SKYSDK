...
enum sky_handle_type
{
	...
	SKY_HANDLE_TYPE_FILE				= 3,
	SKY_HANDLE_TYPE_LIST				= 4,
	SKY_HANDLE_TYPE_MUTEX				= 5,
	SKY_HANDLE_TYPE_RWLOCK				= 6,
	SKY_HANDLE_TYPE_SEMAPHORE			= 7,
	SKY_HANDLE_TYPE_SERIAL				= 8,
	SKY_HANDLE_TYPE_SHARE_MEMORY		= 9,
	SKY_HANDLE_TYPE_SOCKET				= 10,
	SKY_HANDLE_TYPE_TIMER				= 11,
	SKY_HANDLE_TYPE_THREAD				= 12,
	SKY_HANDLE_TYPE_THREAD_POOL		= 13,
	SKY_HANDLE_TYPE_DATA				= 14,
	SKY_HANDLE_TYPE_IPC				= 15,
	SKY_HANDLE_TYPE_REGEX				= 16,
	SKY_HANDLE_TYPE_HASH				= 17,
	SKY_HANDLE_TYPE_DLL				= 18,
...
enum sky_error_class
{
	...
	SKY_ERROR_CLASS_FILE				= 3,
	SKY_ERROR_CLASS_LIST				= 4,
	SKY_ERROR_CLASS_MUTEX				= 5,
	SKY_ERROR_CLASS_RWLOCK				= 6,
	SKY_ERROR_CLASS_SEMAPHORE			= 7,
	SKY_ERROR_CLASS_SERIAL				= 8,
	SKY_ERROR_CLASS_SHARE_MEMORY		= 9,
	SKY_ERROR_CLASS_SOCKET				= 10,
	SKY_ERROR_CLASS_TIMER				= 11,
	SKY_ERROR_CLASS_THREAD				= 12,
	SKY_ERROR_CLASS_THREAD_POOL		= 13,
	SKY_ERROR_CLASS_DATA				= 14,
	SKY_ERROR_CLASS_IPC				= 15,
	SKY_ERROR_CLASS_REGEX				= 16,
	SKY_ERROR_CLASS_HASH				= 17,
	SKY_ERROR_CLASS_DLL				= 18,
